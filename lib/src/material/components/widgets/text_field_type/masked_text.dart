...
// class OwMaskedTextController extends TextEditingController {
//   OwMaskedTextController({String text, this.mask, Map<String, RegExp> translator})
//       : super(text: text) {
//     this.translator = translator ?? OwMaskedTextController.getDefaultTranslator();
